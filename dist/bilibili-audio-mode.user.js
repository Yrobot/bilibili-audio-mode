...
"use strict";(()=>{var i={headphones:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 14h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 18 0v7a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3"/></svg>',headphonesOff:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 14h-1a2 2 0 0 0-2 2v3"/><path d="M3 14h3a2 2 0 0 1 2 2v3"/><path d="M18.5 22H5a2 2 0 0 1-2-2v-7a9 9 0 0 1 13.11-7.95"/><path d="M3 3l18 18"/></svg>',volume2:'<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>'};var n=class{constructor(){this.state={enabled:!0,videoElement:null};this.fab=null;this.statusBadge=null;this.ensureTimer=null}init(){this.state.enabled=this.getStoredState(),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>this.onReady()):this.onReady()}onReady(){this.createFAB(),this.waitForVideo(),this.state.enabled&&this.startEnsureLoop()}getStoredState(){try{let e=window.GM_getValue?.("bam_enabled");return e!==void 0?e:!0}catch{return!0}}saveState(){try{window.GM_setValue?.("bam_enabled",this.state.enabled)}catch{}}startEnsureLoop(){this.stopEnsureLoop();let e=Date.now(),t=15e3;this.ensureTimer=setInterval(()=>{if(Date.now()-e>t){this.stopEnsureLoop();return}let a=this.findVideoElement();a&&a.style.visibility!=="hidden"&&(this.state.videoElement=a,this.applyAudioMode())},300)}stopEnsureLoop(){this.ensureTimer&&(clearInterval(this.ensureTimer),this.ensureTimer=null)}waitForVideo(){let e=this.findVideoElement();if(e){this.setupVideo(e);return}let t=new MutationObserver(()=>{let a=this.findVideoElement();a&&(t.disconnect(),this.setupVideo(a))});t.observe(document.body,{childList:!0,subtree:!0})}setupVideo(e){this.state.videoElement=e}applyAudioMode(){let e=this.state.videoElement;e&&(e.style.visibility="hidden",this.showBadge())}disableAudioMode(){let e=this.state.videoElement;e&&(e.style.visibility="",this.hideBadge())}findVideoElement(){let e=[".bpx-player-video video",".bilibili-player-video video","#bilibili-player video","video"];for(let t of e){let a=document.querySelector(t);if(a instanceof HTMLVideoElement)return a}return null}createFAB(){document.querySelector(".bam-fab")?.remove();let e=document.createElement("button");e.className=`bam-fab ${this.state.enabled?"":"disabled"}`,e.innerHTML=`
    ...
    `,t.addEventListener("click",o=>{o.stopPropagation(),o.preventDefault()}),t.querySelector("a")?.addEventListener("click",o=>{o.stopPropagation(),o.preventDefault(),window.open("https://github.com/Yrobot","_blank","noopener")}),t.querySelector(".bam-badge-close")?.addEventListener("click",o=>{o.stopPropagation(),this.state.enabled=!1,this.saveState(),this.updateFAB(),this.disableAudioMode()}),e.appendChild(t),this.statusBadge=t}hideBadge(){this.statusBadge?.remove(),this.statusBadge=null}};function r(){let s=document.createElement("style");s.textContent=`
    /* ==================== \u60AC\u6D6E\u6309\u94AE (FAB) ==================== */
    .bam-fab {
      position: fixed;
      right: 24px;
